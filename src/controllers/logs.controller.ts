...
import {getLogs, ingestLogBatch,getLogAggregation} from "../services/logs.service.js";
import { validateLogQuery } from "../validators/query.validator.js";
import { validateAggregateQuery } from "../validators/aggregate.validator.js";
...
export async function aggregateLogs(req: Request,res: Response): Promise<void> {
  const filters = validateAggregateQuery(req.query);

  const result = await getLogAggregation(filters);
